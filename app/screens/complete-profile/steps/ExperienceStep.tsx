    ...
    return (
        <View style={{ flex: 1 }}>
            <AnimatePresence exitBeforeEnter>
                {!isAdding ? (
                    /* LIST VIEW - ACTS AS THE MAIN "SCREEN" */
                    <MotiView
                        key="list"
                        from={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    /* FORM VIEW - ACTS AS A FULL SCREEN ENTRY */
                    <MotiView
                        key="form"
                        from={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    >
                        <View style={styles.formHeader}>
                            ...
                            >
                                ...
                                <Text style={[styles.formTitle, { color: theme.text, marginLeft: 10 }]}>Add Work Experience</Text>
                            </TouchableOpacity>
                        </View>
